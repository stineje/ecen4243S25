# RISC-V RV32I Full Instruction Test
# This program ensures all RV32I instructions execute correctly
...
subroutine:
    addi x28, x0, 100   # Set register for jalr test
    jalr x29, x28, 0    # Jump and link register (to PC+100)
